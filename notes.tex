...
\begin{frame}{Zeno Effect}
	\begin{columns}
		\column{.5\textwidth}
		\begin{itemize}
			\item Zeno of Elea (460 BCE): Arrow paradox
			\item Misra and Sudarshan (1977): “The Zeno's paradox in quantum theory”
			\item Experimentally demonstrated (1990) with 5000 $^9$Be$^+$ ions at 250 mK
			\item Used in Magnetometers and possibly birds
		\end{itemize}
		\customcite{kominis_quantum_2009}

		\column{.5\textwidth}
		$$\includegraphics[width=\textwidth]{figures/zeno_data.png}$$
